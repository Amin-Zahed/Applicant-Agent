        ...
        <div className="grid gap-2">
          ...
          {formDatas.username === "notValid" && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                User name must be between 3 and 20 charactors contains uppercase
                and/or lowercase letters and/or numbers and/or under score. also
                you can to place white spaces between charactors
              </AlertDescription>
            </Alert>
          )}
        </div>
          ...
          {formDatas.password === "notValid" && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                ...
                contains minimum 1 number and 1 uppercase and 1 lowercase letter
                and 1 special characters like @ or ~ or \ or ...
              </AlertDescription>
            </Alert>
          )}
        </div>
